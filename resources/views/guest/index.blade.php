                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="circular-image m-4 d-none d-lg-block">
                                <img class="hero-imgmt-5" src="{{ asset('frontend/assets/images/hero-1.webp') }}"
                                alt="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item">
                    <img class="img-fluid zoom-in img-fixed-size d-block w-100"
                        src="{{ asset('frontend/assets/images/hero-2.webp') }}" alt="First slide">
                    <div class="carousel-overlay"></div>
                </div>
                <div class="carousel-item">
                    <img class="img-fluid zoom-in img-fixed-size d-block w-100"
                        src="{{ asset('frontend/assets/images/hero-3.webp') }}" alt="Second slide">
                    <div class="carousel-overlay"></div>
                </div>
                <div class="carousel-item active">
                    <img class="img-fluid zoom-in img-fixed-size d-block w-100"
                        src="{{ asset('frontend/assets/images/hero-4.webp') }}" alt="Third slide">
                    <div class="carousel-overlay"></div>
                </div>
            </div>
        </div>
